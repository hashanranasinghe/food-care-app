class Config {
  ...
  static const String upload = "/api/users/upload";
  static const String getUserRequest = "/api/users/request";
  ...
  static const String completeDonation = "api/food/completedonation";
  static const String getRequestsFood = "api/food/process/request";
  static const String getAcceptFood = "api/food/process/accept";
  static const String getCompleteFood = "api/food/process/complete";
  static String getOwnFoodPost({required String id}) {
    String path = "api/food/ownfood/$id";
    return path;
  }

  static String completeFood({required String id}) {
    String path = "api/food/complete/$id";
    return path;
  }
  ...
  static const String getOwnReports = "/api/report/ownReport";
  static String deleteReport({required String id}) {
    String path = "/api/report/ownReport/$id";
    return path;
  }
}
